...
9. **父 issue、子 issue、Epic**：在「解决 #xxx」「解读 #xxx」等流程的**只读阶段**，若发现正文/评论中有子任务编号或父任务引用，**按 `07-sub-issues.md`** 汇总子 issue 状态、界定本次交付范围、明确是否/何时 `Closes #父`，避免误关或遗漏。
